...
define ANDROID_TOOLS_OVERRIDE_ADBD_MK
$(Q)cp $(TOPDIR)/package/android-tools/adbd-minimal.mk $(@D)/debian/makefiles/adbd.mk
endef

ANDROID_TOOLS_POST_EXTRACT_HOOKS += ANDROID_TOOLS_OVERRIDE_ADBD_MK
